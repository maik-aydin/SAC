  ...
  `;
    ...
    const templateHTML = `
        ...
        <div>
            ...
            <div class="layoutIterations">
                ...
                <input id="layoutIterations" type="number" name="layoutIterations" value="${defaultSettings.layoutIterations}" />
            </div>
            <p>Terms of Use</p>
        </div>
    `;
    ...
    class SankeyChartStylingPanel extends HTMLElement {
        ...
        updateFields() {
            ...
            const layoutIterationsInput = this._shadowRoot.getElementById("layoutIterations");
            layoutIterationsInput.value = this._props.layoutIterations || defaultSettings.layoutIterations;
        }
